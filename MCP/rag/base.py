...
class RetrievalChain(ABC):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        Args:
            **kwargs: Keyword arguments including:
                ...
                embedding_model: Model name for embeddings (default: Upstage "solar-embedding-1-large-query")
                persist_directory: Directory to persist vector store
        """

        self.source_uri = kwargs.get("source_uri", [])
        self.k = kwargs.get("k", 5)
        self.embedding_model = kwargs.get("embedding_model", "solar-embedding-1-large-query")
    ...
    def create_embedding(self) -> Any:
        ...
        return UpstageEmbeddings(model=self.embedding_model)
